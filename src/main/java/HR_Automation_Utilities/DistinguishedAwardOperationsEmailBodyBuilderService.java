...
public class DistinguishedAwardOperationsEmailBodyBuilderService {
    ...
    public static String buildEligibilityEmailBody() throws Exception {
        ...
        htmlBuilder.append("<th style='padding: 2px 30px;border: 2px solid black;'>Department</th>");
        htmlBuilder.append("<th style='padding: 2px 30px;border: 2px solid black;'>")
                .append("Distinguish Eligibility</th>");
        htmlBuilder.append("</tr>");
        htmlBuilder.append(ExcelUtilities.readDistinguishedOperationsData("Ops_Distinguished"));
